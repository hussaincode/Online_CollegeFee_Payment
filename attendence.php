...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">
        ...
        <li class="active"><a href="attendence.php"><span class="glyphicon glyphicon-education"></span>attendence</a></li>
    </ul>
</div><!-- /span-3 -->
...
?>
                ...
                <h3 align="center" style="color:blue">Your Attendance is <?php echo $attendence=$row['attendence']; ?>%</h3>    
